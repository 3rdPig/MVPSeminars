...
{
    public partial class CreateContentManagementSchema : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BusinessTrainingTopic", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BusinessTrainingTopic_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Categories_Topics_NameId",
                        column: x => x.NameId,
                        principalTable: "Topics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KeynoteTopic", x => x.Id);
                    table.ForeignKey(
                        name: "FK_KeynoteTopic_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Specialization_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BusinessTrainingTopic_ApplicationUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KeynoteTopic_ApplicationUserId",
                table: "KeynoteTopic",
                column: "ApplicationUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Specialization_ApplicationUserId",
